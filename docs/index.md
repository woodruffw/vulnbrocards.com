...
!!! example
    ...
    Many legal system have a _de minimis_ principle, which
    precludes legal considerations of trivia or "trifling"
    matters.

    For example, New York has a
    ["trivial defect"](https://www.citylandnyc.org/small-small-trivial-doctrine-new-york-law/)
    standard that is used to evaluate trip-and-fall lawsuits. A judge can use this standard to
    evaluate the evidence and issue a summary judgement if appropriate, potentially
    avoiding a lengthy and expensive trial process.

    In the same way, vulnerability brocards can help us issue
    "summary judgments" during vulnerability triage.


Read on to see [how you can use](./how-to-use.md) vulnerability brocards.
